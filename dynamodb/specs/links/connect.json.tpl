    ...
    "schema": {
      ...
      "properties": {
        ...
        "table_name": {
          ...
          "editableOn": [],
          "description": "DynamoDB table name this link grants access to (shown for reference; the service exports it as an environment variable)",
          "order": 4
        },
        "table_region": {
          "type": "string",
          ...
          "editableOn": [],
          "description": "AWS region of the table (shown for reference; the service exports it as an environment variable)",
          "order": 5
        },
        "iam_user_name": {
          "type": "string",
